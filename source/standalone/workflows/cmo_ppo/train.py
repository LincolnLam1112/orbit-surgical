...
"""Script to train CMO PPO agent with RSL-RL."""
...
from cmo_on_policy_runner import CMOOnPolicyRunner  # <-- changed
...
def main():
    ...
    # ---------------------------------------------------------------------
    # Optional: enable no-slip clamp behaviour for needle orientation task
    # ---------------------------------------------------------------------
    ...
    # create runner from rsl-rl (CMO PPO runner)
    runner = CMOOnPolicyRunner(env, agent_cfg.to_dict(), log_dir=log_dir, device=agent_cfg.device)
