...
from . import mdp
from .mdp.rewards import PhasedPickupRewardWrapper
...
class EventCfg:
    ...
    reset_all = EventTerm(func=events.reset_scene_with_reward_reset, mode="reset")
...
class RewardsCfg:
    ...
    pickup = RewTerm(
        func=PhasedPickupRewardWrapper(
